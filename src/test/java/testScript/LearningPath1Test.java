...
public class LearningPath1Test extends BaseClass {
    ...
    public void loginStudent() throws Exception {
        ...
        Thread.sleep(4000);
        WebElement elemento4 = studentHomePage.namePathGetStudent();
        Thread.sleep(3000);
        Assert.assertEquals(elemento4.getText(), "QA Track Con Rewards");
        ...
        studentHomePage.learnPathButton();
        Thread.sleep(4000);
        WebElement elemento5 = studentHomePage.namePathGetStudent();
        if (!studentHomePage.isElementPresent()){
            System.out.println("El texto del elemento es 'desactivada'. Test Passed.");
        }else {
            System.out.println("Desactivada'. Test Passed.");
        }
    }
}
